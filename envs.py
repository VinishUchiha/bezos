...
class VecBezos(VecEnvWrapper):
    """
    We extend the VecEnvWrapper of baseline to make it consistent with our implmentation
    """
    def __init__(self, vectorized_env, device):
        """Return only every `skip`-th frame"""
        super(VecEnvWrapper, self).__init__(vectorized_env)
        self.device = device
